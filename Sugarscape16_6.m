...
%% Exercise 16.6 Sugarscape with a finite lifespan for the agents %%
clear all;
...
if age(agent) == maxAge(agent)
    age(agent) = 0;
    vision(agent) = unidrnd(6);
    metabolism(agent) = unidrnd(4);
    maxAge(agent) = unidrnd(41) + 59;
    sugar(i,agent) = unidrnd(21) + 4;
end
